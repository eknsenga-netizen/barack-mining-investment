...
export const metadata: Metadata = {
  title: 'Gestion des opérations minières | Barack Mining Investment',
  description:
    'Gestion et coordination des opérations minières : production, extraction, transport, suivi GPS des chargements, pont bascule, approvisionnements, supply chain et reporting.',
}
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[#080A09] pt-[78px] text-white">
        ...
        <Image
          ...
          alt="Gestion et suivi des opérations minières de Barack Mining Investment"
          fill
          priority
          sizes="100vw"
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#050606]/88 via-[#050606]/60 to-[#050606]/18" />
        ...
        <div className="relative z-10 mx-auto flex min-h-[610px] w-full max-w-7xl items-center px-6 py-24 sm:px-8 lg:px-10">
          ...
          <div className="w-full">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="max-w-4xl text-4xl font-semibold leading-[1.01] tracking-[-0.055em] sm:text-5xl md:text-6xl lg:text-[68px]">
              ...
              <p className="mt-7 max-w-2xl text-sm leading-7 text-white/65 sm:text-base sm:leading-8">
                Coordonner les opérations de la mine jusqu’à l’usine en
                assurant le suivi des chargements, des trajets et des flux
                logistiques grâce aux outils de suivi opérationnel et aux
                données enregistrées lors du passage au pont bascule.
              </p>
