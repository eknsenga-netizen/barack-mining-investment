...
export const metadata: Metadata = {
  title: 'Approvisionnement minéral | Barack Mining Investment',
  description:
    'Facilitation de l’approvisionnement minéral, mise en relation commerciale, logistique, traçabilité et développement d’opportunités dans le secteur minier.',
}
    ...
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[#080A09] pt-[78px] text-white">
        ...
        <Image
          ...
          alt="Approvisionnement et chaîne de valeur minérale"
          fill
          priority
          sizes="100vw"
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_28%_20%,rgba(225,196,135,0.16),transparent_30%)]" />
          ...
          <div className="w-full">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-7 max-w-2xl text-sm leading-7 text-white/65 sm:text-base sm:leading-8">
                Faciliter les échanges entre détenteurs de ressources,
                fournisseurs et acheteurs, tout en structurant les flux
                commerciaux, logistiques et les informations nécessaires
                au suivi des opportunités.
              </p>
