...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez nos domaines d’expertise : prospection, exploration, opérations, approvisionnement et support aux projets.',
}
...
const activities = [
  ...
  },
  {
    title: 'Exploration',
    description:
      'Approfondir la compréhension géologique et technique des ressources.',
  ...
  },
  {
    ...
    description:
      'Gérer et coordonner les opérations minières et la chaîne d’approvisionnement.',
  ...
  },
  {
    ...
    description:
      'Faciliter l’approvisionnement et les opportunités commerciales.',
  ...
  },
  {
    ...
    description:
      'Accompagner les projets, les investisseurs et les partenaires stratégiques.',
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-28 sm:px-8 lg:px-10">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-7 max-w-2xl text-sm leading-7 text-white/65 sm:text-base sm:leading-8">
              Cinq domaines d’expertise pour couvrir toute la chaîne de valeur
              minière.
            </p>
          ...
          <div className="mb-14 flex flex-col justify-between gap-7 lg:flex-row lg:items-end">
            ...
            <div className="max-w-sm">
              ...
              <p className="text-sm leading-7 text-stone-500">
                Une approche structurée pour transformer les opportunités
                minières en projets solides et durables.
              </p>
              ...
              (activity, index) => {
                ...
                return (
                  <Link
                    key={activity.href}
                    href={activity.href}
                    className={`group relative flex min-h-[340px] flex-col overflow-hidden rounded-[26px] border p-7 transition-all duration-500 sm:p-8 ${
                      isFeatured
                        ? 'border-[#D7B66C]/35 bg-[#0A0C0B] text-white shadow-[0_28px_75px_rgba(10,12,11,0.14)] lg:translate-y-4'
            ...
            <div className="relative flex flex-col gap-5 px-6 py-6 sm:flex-row sm:items-center sm:justify-between sm:px-8">
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-stone-500">
                  De la prospection à l’accompagnement stratégique des projets
                  miniers.
                </p>
