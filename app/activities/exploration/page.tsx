...
export const metadata: Metadata = {
  title: 'Exploration minière | Barack Mining Investment',
  description:
    "L'exploration minière : études géologiques, échantillonnage approfondi, évaluation du potentiel et développement progressif des connaissances.",
}
  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[#080A09] pt-[78px] text-white">
        ...
        <Image
          src="/images/exploration-hero.jpg"
          alt="Exploration minière de Barack Mining Investment"
          fill
          priority
          sizes="100vw"
          ...
          <div className="w-full">
            ...
            <div className="max-w-4xl">
              ...
              <p className="mt-7 max-w-2xl text-sm leading-7 text-white/65 sm:text-base sm:leading-8">
                Approfondir la compréhension géologique et technique des
                ressources potentielles à travers des études ciblées, des
                travaux de terrain et l’analyse des données disponibles.
              </p>
