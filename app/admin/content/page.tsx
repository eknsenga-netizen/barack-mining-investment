  ...
  return (
    <div className="rounded-[26px] border border-slate-200 bg-white px-6 py-16 text-center shadow-[0_10px_35px_rgba(15,23,42,0.04)]">
      ...
      <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-slate-500">
        {filtered
          ? 'No article matches the current search and filters.'
          : 'There are currently no news articles in the content workspace.'}
      </p>
...
export default function ContentPage() {
    ...
    async (isRefresh = false) => {
      ...
      try {
        ...
        if (queryError) {
          ...
          setError(
            'Unable to load news articles. Please check your permissions and try again.'
          )
  ...
  const handleDelete = async (
    ...
    try {
      ...
      console.error(
        'News deletion request error:',
        deleteRequestError
      )

      setError(
        'An unexpected error occurred while deleting this article.'
      )
    }
  }
      ...
      <div className="flex min-h-[70vh] items-center justify-center px-4">
        ...
        <div className="text-center">
          ...
          <p className="mt-1 text-xs text-slate-500">
            Preparing the content workspace...
          </p>
    ...
    <div className="space-y-6 pb-10">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
                Manage the news and editorial content displayed on the Barack Mining Investment public website.
              </p>
      ...
      <section className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <p className="mt-1 text-xs text-slate-500">
            Waiting for editorial validation
          </p>
      ...
      <Section
        eyebrow="Editorial"
        title="News register"
        description="Search and filter the articles managed by the Content workspace."
      >
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          {statusFilter !== 'all' && (
            <FilterBadge
              label={`Status: ${
                STATUS_LABELS[
                  statusFilter as NewsItem['status']
                ]
              }`}
              onRemove={() =>
                setStatusFilter('all')
          ...
          {categoryFilter !== 'all' && (
            <FilterBadge
              label={`Category: ${
                CATEGORY_LABELS[
                  categoryFilter as NewsItem['category']
                ]
              }`}
              onRemove={() =>
                setCategoryFilter('all')
                        ...
                        <td className="px-5 py-4">
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="max-w-[350px] truncate text-sm font-semibold text-slate-950">
                                {item.title}
                              </p>
          ...
          <section className="space-y-3 md:hidden">
            ...
            {filteredNews.map(
              (item) => (
                <article
                  key={item.id}
                  className="rounded-[22px] border border-slate-200 bg-white p-5 shadow-[0_8px_30px_rgba(15,23,42,0.04)]"
                >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[10px] leading-5 text-slate-400">
              Content access is controlled by authenticated roles and Supabase RLS policies.
            </p>
