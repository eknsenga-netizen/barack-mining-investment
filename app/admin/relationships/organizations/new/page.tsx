    ...
    <div className="flex min-h-[70vh] items-center justify-center">
      <div className="text-center">
        ...
        <p className="mt-4 text-sm font-semibold text-slate-900">
          Preparing organization creation
        </p>
...
export default function NewOrganizationPage() {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      setError(
        submitError?.message ||
          'Unable to create this organization.'
      )
    } finally {
      setLoading(false)
    }
      ...
      <div className="flex min-h-[70vh] items-center justify-center px-4">
        ...
        <div className="w-full max-w-md rounded-[28px] border border-red-200 bg-white p-8 text-center shadow-[0_20px_70px_rgba(15,23,42,0.08)]">
          ...
          <p className="mt-2 text-sm leading-6 text-slate-500">
            Your current role does not have permission to create organization records.
          </p>
        ...
        <div className="mt-6 flex flex-col gap-5 sm:flex-row sm:items-start">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
              Add a new organization to the Barack Mining Investment relationship database.
            </p>
      ...
      <div className="grid gap-6 xl:grid-cols-[minmax(0,1.45fr)_360px]">
        ...
        >
          ...
          <Section
            ...
            description="Enter the core identity and business details for this relationship."
          >
            ...
            <div className="space-y-5">
              ...
              <FormField
                ...
                value={name}
                onChange={setName}
                placeholder="e.g. Katanga Mining Company"
                icon={
                  <Building2 size={15} />
                }
                required
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <FormField
                  ...
                  value={type}
                  onChange={setType}
                  placeholder="e.g. Mining Company"
                  icon={
                    <Users size={15} />
                  }
                />
          ...
          <Section
            ...
            description="Review how the organization will appear in the relationship workspace."
          >
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50/60 p-5">
              ...
              {website.trim() && (
                <div className="mt-5 border-t border-slate-200 pt-4">
                  ...
                  <div className="inline-flex max-w-full items-center gap-2 text-xs font-medium text-[#A96F35]">
                    <Globe2 size={14} />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] leading-5 text-emerald-700/70">
                    Your role has permission to create organization records.
                    Supabase authentication and RLS remain responsible for
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-emerald-700/80">
                    The organization record has been created. Returning to relationships...
                  </p>
        ...
        <aside className="space-y-6">
          ...
          >
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="mt-4 max-w-full truncate text-base font-semibold text-slate-950">
                {previewName}
              </h3>

              <p className="mt-1 text-xs text-slate-400">
                Draft organization record
              </p>

              <span className="mt-4 inline-flex max-w-full items-center rounded-full bg-slate-100 px-3 py-1.5 text-[10px] font-semibold text-slate-600">
                {previewType}
              </span>
          ...
          <Section
            ...
            description="The following information will be stored in the organizations table."
          >
            ...
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-[10px] leading-5 text-emerald-700/70">
                    Organization creation is limited to authorized administration roles.
                  </p>
